...
class AttendanceExport implements FromCollection, WithMapping, WithHeadings
{
    ...
    */
    ...
    {
        return Attendanc::whereYear('date', $this->year)->whereMonth('date', $this->month)->where('grade_id', $this->grade)->whereMonth('date', $this->month)->whereHas('student', function($query) {
